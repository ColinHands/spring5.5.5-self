 ...
 * 然后可以使用产生的{@code typeRef}实例来获得一个{@link Type}实例，该实例在运行时携带捕获的参数化类型信息。
 * For more information on "super type tokens" see the link to Neal Gafter's blog post.
 * 有关“超级类型令牌”的更多信息，请参见Neal Gafter的博客文章链接。
 *
