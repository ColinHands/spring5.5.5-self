...
public class AspectJExpressionPointcut extends AbstractExpressionPointcut
	...
	public boolean matches(Method method, Class<?> targetClass, boolean hasIntroductions) {
		...
		// Spring中对this, target， @this， @target， @annotation的特殊处理
		// 我们可以优化，因为我们知道我们有这个类，而且在运行时不会有匹配的子类。
	...
	public boolean matches(Method method, Class<?> targetClass, Object... args) {
		...
		// consistent with return of MethodInvocationProceedingJoinPoint 将Spring AOP代理绑定到AspectJ“this”，将Spring AOP目标绑定到AspectJ目标，这与方法调用proceedingjoinpoint的返回一致
